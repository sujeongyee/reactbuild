          ...
          <div className="row">
            <div className="col-12">
              <div className="card">
                <div
                  className="card-body"
                  style={{ padding: "30px 70px 0 100px", height: "750px" }}
                >
                  <a className="inq-back">← 문의 목록</a>
                  ...
                  <article className="inq-content">
                    <p>
                      프로젝트 관련 문의 남깁니다 답변 부탁드립니다 . 저희
                      회사는 프로젝트 관련 문의 남깁니다 답변 부탁드립니다 .
                      저희 회사는 프로젝트 관련 문의 남깁니다 답변 부탁드립니다
                      . 저희 회사는 프로젝트 관련 문의 남깁니다 답변
                      부탁드립니다 . 저희 회사는 프로젝트 관련 문의 남깁니다
                      답변 부탁드립니다 . 저희 회사는 프로젝트 관련 문의
                      남깁니다 답변 부탁드립니다 . 저희 회사는 프로젝트 관련
                      문의 남깁니다 답변 부탁드립니다 . 저희 회사는 프로젝트
                      관련 문의 남깁니다 답변 부탁드립니다 . 저희 회사는
                      프로젝트 관련 문의 남깁니다 답변 부탁드립니다 . 저희
                      회사는 프로젝트 관련 문의 남깁니다 답변 부탁드립니다 .
                      저희 회사는 프로젝트 관련 문의 남깁니다 답변 부탁드립니다
                      . 저희 회사는 프로젝트 관련 문의 남깁니다 답변
                    ...
                    <div className="row inq-answer">
                      ...
                      <div className="commentBtn">
                        <div className="btn-list">
                          <button
                            type="button"
                            className="btn waves-effect waves-light - inq-answer-btn"
                          >
                            등록
                          </button>
                        </div>
