...
function Login_join() {
  ...
  const myFunction = async () => {
    ...
    const check = { cus_pw_check: cus_pw_check.value, cus_pw: cus_pw.value };
            ...
            <div className="form-wrapper align-items-center">
              <div className="form sign-up">
                ...
                <div className="lj_input-group">
                  ...
                  {businessCh.error != "undefined" || businessCh.error != "" ? (
                ...
                {errForm.cus_email != "undefined" || errForm.cus_email != "" ? (
