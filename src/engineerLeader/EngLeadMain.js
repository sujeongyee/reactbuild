        ...
        <div className="container-fluid">
              ...
              <div className="card border-end cardpd">
                <div className="card-body">
                  ...
                  <div className="d-flex ">
                    <div>
                      <div className="d-inline-flex ">
                        <h2 className=" mb-1 font-weight-medium change-color-engl">{vo.serverCount}개</h2>
                      </div>

                      <h6 className="text-muted font-weight-normal mb-0 w-100 text-truncate">관리중인 서버수</h6>
          ...
          <div className="row row-here">
            <div className="listsize reqsize" style={{ margin: '0 10px' }}>
              <div className="col-lg-3 engl-main-car" style={{ float: 'none', margin: '0 10px', display: 'inline-block', width: '600px' }}>
                <div className="card cardpd engl-mian-car">
                  <div className="card-body engl-cardBody">
                    <div className=" listclient mb-4">
                      <h4 className="card-title" style={{ display: 'inline-block' }} >새로 배정된 프로젝트 리스트</h4>
                      <span style={{ marginLeft: '13px', color: 'rgb(129 132 135)' }}>(빠르게 엔지니어 배정 해주세요)</span>
                      ...
                      <table className="table v-middle mb-0 tablesize">
                        <thead>
                          <tr className="border-0">
                            ...
                            <th className="border-0 font-14 font-weight-medium text-muted " style={{ paddingLeft: '10px' }}>
                              계약시작일
                            </th>
            ...
            <div className="card cardpd " style={{ width: '380px' }}>
              <h4 className="card-title engl-condition" style={{ display: 'inline-block', padding: '20px', paddingBottom: '0', fontSize: '16px' }} >이달의 팀 계약 현황</h4>
              <div className="engl-main-chart card-body engl-cardBody" style={{ width: '100%' }} ><Doughnut data={data} /></div>
            </div>
          </div>
              ...
              >
                <div class="card cardpd">
                  <div class="card-body">
                    ...
                    >
                      <EnglChartComponent periodic={periodic} disability={disability} maintenance={maintenance} />
                    </div>
                  </div>
                </div>
              </div>
