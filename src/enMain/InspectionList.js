                ...
                <div className="container-fluid">
                    ...
                    <div className="searchIcon">
                      <FormControlIcon />
                                        ...
                                        <select onChange={selectee1} style={{ height: "30px", color: "#9cbba6", position: "absolute", top: '10px', left: "100px" }} >
                                                ...
                                                {currentItems.map((workInfo, index) => (
                                                    <tr key={index}>
                                                        ...
                                                        <td>
                                                            <button
                                                                type="button"
                                                                class={`btn waves-effect waves-light btn-rounded ${workInfo.server_status === 'GOOD' ? 'btn-success' : 'btn-warning'
                                                                    }`}
                                                                style={{ width: '80px' }}>
