      ...
      >
            ...
            <input
              ...
              onChange={(e) => setNewEvent({
                ...newEvent,
                description: { ...newEvent.description, '점검종류': e.target.value },
              })}
            />
            <input
              type="text"
              ...
              onChange={(e) => setNewEvent({
                ...newEvent,
                description: { ...newEvent.description, '점검내용': e.target.value },
              })}
            />
            <input
              type="text"
              ...
              onChange={(e) => setNewEvent({
                ...newEvent,
                description: { ...newEvent.description, '프로젝트 명': e.target.value },
              })}
            />
            {/* 추가 정보 입력 */}
