...
function testCalendar() {
  ...
  return (
    ...
    <header class="header">
        <nav class="navbar">
          ...
          <button class="button is-rounded next">
            <img alt="prev" src="./images/ic-arrow-line-right.png" srcset="./images/ic-arrow-line-right@2x.png 2x, ./images/ic-arrow-line-right@3x.png 3x"/>
          </button>
    ...
    <div style={{width: '600px', height: '600px', margin: '0 auto', paddingTop: '30px'}}>
      <Calendar
        view="month"
        month={{
