                      ...
                      <div className="col-md-4sy">
                        <div className="form-group mb-3">
                          <input
                            ...
                            placeholder={checkPermission.sub}
                            readOnly
                          />
                        </div>
                      </div>
                      ...
                      <div className="col-md-4sy">
                        <div className="row" style={{ width: "119%" }}>
                            ...
                            >
                              <div className="form-group mb-3">
                                <select
                                  onChange={noticeChange}
                                  name="notice_target"
                                  value={form.notice_target}
                                  class="custom-select custom-select-set form-control bg-white border-0 custom-shadow custom-radius"
                                >
                                  <option value="ALL">전체</option>
                                  <option value="ROLE_ENGINEER">
                                    엔지니어
                                  </option>
                          ...
                          <div className="row" style={{ width: "50%" }}>
                            ...
                            >
                              <div
                                className="form-group mb-3" /* style={{ padding:"0"}} */
                              >
                                <div style={{ textAlign: "center" }}>
                                  댓글여부
                                </div>
